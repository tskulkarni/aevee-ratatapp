...
// All Rights Reserved.
//
#ifndef INCLUDED_RAAT_PLUGIN_OUTPUT_CAPTURE_H
#define INCLUDED_RAAT_PLUGIN_OUTPUT_CAPTURE_H
...
void
RAAT__capture_output_plugin_delete(RAAT__OutputPlugin *out_output);

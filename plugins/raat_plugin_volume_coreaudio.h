...
// All Rights Reserved.
//
#ifndef INCLUDED_RAAT_PLUGIN_VOLUME_COREAUDIO_H
#define INCLUDED_RAAT_PLUGIN_VOLUME_COREAUDIO_H
...
void
RAAT__coreaudio_volume_plugin_delete(RAAT__VolumePlugin *out_volume);

...
// All Rights Reserved.
//
#ifndef INCLUDED_RAAT_PLUGIN_VOLUME_INCREMENTAL_H
#define INCLUDED_RAAT_PLUGIN_VOLUME_INCREMENTAL_H
...
void
RAAT__incremental_volume_plugin_delete(RAAT__VolumePlugin *out_volume);
